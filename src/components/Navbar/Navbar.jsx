  ...
  return (
    <div className="navbar">
        ...
        <ul ref={menuRef} className="nav-menu">
            <img src={menu_close} alt="" onClick={closeMenu} className='menu-mob-close'/>
            <li><AnchorLink className='anchor-link' href='#hero'><p onClick={()=>setMenu("home")}>Home</p></AnchorLink>{menu==="home"?<img src={underline} />:<></>}</li>
